...
const UserInfo = ({ firstName, lastName, id, avatarPath }) => {
  ...
  const LogOutNotification = () =>
    toast.success("logged out sucessfully , redirecting to sign in page", {
      position: "top-center",
      autoClose: 1500,
            ...
            {(role === "O" && (
              <>
                ...
                >
                  ...
                  <Typography className="menuItem-typo">Wallet</Typography>
                </MenuItem>

                <MenuItem
                  onClick={() => menuClickHandler("/Panel")}
                  sx={{
                    m: (0.5, 1),
                    borderRadius: 1.2,
                    "&:hover": {
                ...
                >
                  ...
                  <Typography className="menuItem-typo" sx={{ color: "red" }}>
                    LogOut!
                  </Typography>
                </MenuItem>
              </>
              ...
              (role === "C" && (
                <>
                  ...
                  >
                    ...
                    <Typography className="menuItem-typo">History</Typography>
                  </MenuItem>
                  <MenuItem
                    disabled={loggingOut}
                    onClick={LogOutClickHandler}
              ...
              (role === "T" && (
                <>
                  ...
                  <MenuItem
                    onClick={() => menuClickHandler("/tourleader-profile")}
                    sx={{
                      m: (0.5, 1),
                      borderRadius: 1.2,
                      "&:hover": {

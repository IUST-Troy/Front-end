...
const Tourleaderprofile = () => {
  ...
  const [imgValuephoto, setImgValuephoto] = React.useState("");

  const handleImgValuephoto = (event) => {
    if (event.target.files && event.target.files[0]) {
      const reader = new FileReader();
      reader.onload = (e) => setImgValue(e.target.result);
  ...
  const submitButtonPassword = () => {
    ...
    axios
      .post("http://mrsz.pythonanywhere.com/auth/users/set_password/", data, {
        headers: {
      ...
      .catch((err) => {
        console.log(err);
        toast.error(
          "Error! Your Password Change was NOT successful!" + err.message,
          {
            position: "top-right",
            autoClose: 1500,
            className: "toast-message",
  ...
  const submitButtonUserName = () => {
    ...
    axios
      .post("http://mrsz.pythonanywhere.com/auth/users/set_username/", data, {
        headers: {
          Authorization: `JWT ${localStorage.getItem("acctoken")}`,
          "Content-Type": "application/json",
        },
      ...
      .catch((err) => {
        console.log(err);
        toast.error(
          "Error! Your username Change was NOT successful!" + err.message,
          {
            position: "top-right",
            autoClose: 1500,
            className: "toast-message",
            ...
            <div className="grid grid-cols-1 gap-4 ">
              <div className="grid md:grid-cols-2 md:gap-0 sm:grid-cols-1 sm:gap-2">
                ...
                <div className="rightside grid grid-cols-1 gap-4 p-8">
                  ...
                  <div>
                    <div className="flex justify-start items-center pl-1 text-gray-700">
                      <BsPersonFillCheck className="mr-1" />
